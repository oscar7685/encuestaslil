 ...
 * @author acreditacion
 */
public class InformeXpreguntaVinculacion implements Action {
    ...
    public String procesar(HttpServletRequest request) throws IOException, ServletException {
        ...
        String vinculacion = (String) request.getParameter("vinculacion");
        ...
        for (Pregunta pregunta : preguntas) {
            ...
            if ("0".equals(pregunta.getTipo())) {
                ...
                for (Respuesta respuesta : respuestas) {
                    if (vinculacion != null && !vinculacion.equals("NA")) {
                        List<Resultados> resultados = resultadosFacade.findByList3("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "personaIdpersona.vinculacion", vinculacion);
                ...
                if ("true".equals(pregunta.getOtro())) {
                    if (vinculacion != null && !vinculacion.equals("NA")) {
                        List<Resultados> resultados2 = resultadosFacade.findByList2Especial2("preguntaIdpregunta", pregunta, "personaIdpersona.vinculacion", vinculacion);
                ...
                for (Respuesta respuesta : respuestas) {
                    ...
                    if (vinculacion != null && !vinculacion.equals("NA")) {
                        resultados = resultadosFacade.findByList3("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "personaIdpersona.vinculacion", vinculacion);
                    }

                    if ("true".equals(pregunta.getOtro())) {
                        if (vinculacion != null && !vinculacion.equals("NA")) {
                            for (int i = 0; i <= respuestas.size(); i++) {
                                List<Resultados> CantidadOrdenresultados = resultadosFacade.findByList4("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "orden", i + 1, "personaIdpersona.vinculacion", vinculacion);
                ...
                if ("true".equals(pregunta.getOtro())) {
                    ...
                    if (vinculacion != null && !vinculacion.equals("NA")) {
                        for (int i = 0; i <= respuestas.size(); i++) {
                            List<Resultados> CantidadOrdenresultados2 = resultadosFacade.findByList2Especial3("preguntaIdpregunta", pregunta, "orden", i + 1, "personaIdpersona.vinculacion", vinculacion);
                ...
                if (vinculacion != null && !vinculacion.equals("NA")) {
                    resultadoAbierta = resultadosFacade.findByList2("preguntaIdpregunta", pregunta, "personaIdpersona.vinculacion", vinculacion);
                }
                ...
                if (vinculacion != null && !vinculacion.equals("NA")) {
                    for (Respuesta respuesta : respuestas6) {
                        List<Resultados> resultados6 = resultadosFacade.findByList4("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "valor", "Si", "personaIdpersona.vinculacion", vinculacion);
