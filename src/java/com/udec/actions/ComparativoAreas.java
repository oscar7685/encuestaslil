 ...
 * @author acreditacion
 */
public class ComparativoAreas implements Action {
ResultadosFacade resultadosFacade = lookupResultadosFacadeBean();
    ...
    public String procesar(HttpServletRequest request) throws IOException, ServletException {
        ...
        List<List> cantidadPersonasxPreguntaF = new ArrayList<List>();
        List<List> totalrespuestasF = new ArrayList<List>();
        List<List<List>> cantidadXrespuestaXPreguntaF = new ArrayList<List<List>>();
        List<List<List>> cantidadXrespuestaXPregunta6F = new ArrayList<List<List>>();
        List<List<List>> RespuestasPreguntasAbiertasF = new ArrayList<List<List>>();
        List<List<List<List>>> cantidadXOrdenXrespuestaXPreguntaF = new ArrayList<List<List<List>>>();
        ...
        List<List> RespuestasPreguntasAbiertas = new ArrayList<List>();
        List totalrespuestas = new ArrayList();
        List<List> cantidadXrespuestaXPregunta = new ArrayList<List>();
        List<List> cantidadXrespuestaXPregunta6 = new ArrayList<List>();

        List<List<List>> cantidadXOrdenXrespuestaXPregunta = new ArrayList<List<List>>();
        int preguntaIndex = 0;
        for (Pregunta pregunta : preguntas) {
            ...
            List<List> cantidadOrdenRespuestasPreguntaActual = new ArrayList<List>();
            if ("0".equals(pregunta.getTipo())) {
                ...
                for (Respuesta respuesta : respuestas) {
                    if (!area.equals("NA")) {
                        List<Resultados> resultados = resultadosFacade.findByList3("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "personaIdpersona.programaIdprograma.area", area);
                ...
                if ("true".equals(pregunta.getOtro())) {
                    if (!area.equals("NA")) {
                        List<Resultados> resultados2 = resultadosFacade.findByList2EspecialParametro1("preguntaIdpregunta", pregunta, "personaIdpersona.programaIdprograma.area", area);
                ...
                for (Respuesta respuesta : respuestas) {
                    ...
                    if (!area.equals("NA")) {
                        resultados = resultadosFacade.findByList3("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "personaIdpersona.programaIdprograma.area", area);
                    }
                    ...
                    if ("true".equals(pregunta.getOtro())) {
                        ...
                        if ( !area.equals("NA")) {
                            for (int i = 0; i <= respuestas.size(); i++) {
                                List<Resultados> CantidadOrdenresultados = resultadosFacade.findByList4("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "orden", i + 1, "personaIdpersona.programaIdprograma.area", area);
                ...
                if ("true".equals(pregunta.getOtro())) {
                    ...
                    if ( !area.equals("NA")) {
                        for (int i = 0; i <= respuestas.size(); i++) {
                            List<Resultados> CantidadOrdenresultados2 = resultadosFacade.findByList2Especial3("preguntaIdpregunta", pregunta, "orden", i + 1, "personaIdpersona.programaIdprograma.area", area);
                ...
                if ( !area.equals("NA")) {
                    resultadoAbierta = resultadosFacade.findByList2("preguntaIdpregunta", pregunta, "personaIdpersona.programaIdprograma.area", area);
                }
                ...
                if ( !area.equals("NA")) {
                    for (Respuesta respuesta : respuestas6) {
                        List<Resultados> resultados6 = resultadosFacade.findByList4("preguntaIdpregunta", pregunta, "respuestaIdrespuesta", respuesta, "valor", "Si", "personaIdpersona.programaIdprograma.area", area);
        ...
        //sesion.setAttribute("cantidadPersonasXpregunta1", cantidadPersonasxPregunta);
        sesion.setAttribute("preguntas", preguntas);
        //sesion.setAttribute("totalrespuestas1", totalrespuestas);
        //ccantidadXrespuestaXPregunta", cantidadXrespuestaXPregunta);
        //sesion.setAttribute("cantidadXrespuestaXPregunta6", cantidadXrespuestaXPregunta6); //tipo 6
        //sesion.setAttribute("cantidadXOrdenXrespuestaXPregunta1", cantidadXOrdenXrespuestaXPregunta);
        ...
        cantidadPersonasxPreguntaF.add(cantidadPersonasxPregunta);
        totalrespuestasF.add(totalrespuestas);
        cantidadXrespuestaXPreguntaF.add(cantidadXrespuestaXPregunta);
        cantidadXrespuestaXPregunta6F.add(cantidadXrespuestaXPregunta6);
        RespuestasPreguntasAbiertasF.add(RespuestasPreguntasAbiertas);
        cantidadXOrdenXrespuestaXPreguntaF.add(cantidadXOrdenXrespuestaXPregunta);
        
        }
        
        sesion.setAttribute("cantidadPersonasxPreguntaF", cantidadPersonasxPreguntaF);
        sesion.setAttribute("totalrespuestasF", totalrespuestasF);
        sesion.setAttribute("cantidadXrespuestaXPreguntaF", cantidadXrespuestaXPreguntaF);
        sesion.setAttribute("cantidadXrespuestaXPregunta6F", cantidadXrespuestaXPregunta6F);
        sesion.setAttribute("RespuestasPreguntasAbiertasF", RespuestasPreguntasAbiertasF);
        sesion.setAttribute("cantidadXOrdenXrespuestaXPreguntaF", cantidadXOrdenXrespuestaXPreguntaF);
        

        String url = "informes/comparativoAreas.jsp"; 
